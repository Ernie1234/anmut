        ...
        <div className="mx-auto max-w-screen-xl">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              <a
                href="https://www.facebook.com/Anmutdevelopers/"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://www.instagram.com/anmutdevelopers?fbclid=IwAR1B3I-DvhW42Qyew_9vUYsoWPMPmALzaxD17pVAVf6yKq7V9ncdjfRtIbI"
                target="_blank"
                rel="noreferrer"
                className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
              >
              ...
              <a
                href="https://x.com/Anmutdevelopers?s=20"
                target="_blank"
                rel="noreferrer"
                className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
              >
